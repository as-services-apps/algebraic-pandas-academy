...
import { Car, Trophy, Zap, Sparkles } from 'lucide-react';
        ...
        {!isStarted ? (
          ...
          <div className="text-center space-y-3">
            ...
            <div className="flex gap-2 justify-center">
              ...
              <Button variant="outline" onClick={handleBackToTopic}>
                New Topic
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="text-center">
              <div className="text-xl md:text-2xl font-bold text-foreground mb-2">{currentQuestion.question}</div>
            </div>
